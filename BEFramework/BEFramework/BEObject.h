...
/**
 Returns the instance of `BERelation` class associated with the given key.
 ...
 */
- (void)saveInBackgroundWithBlock:(nullable BEBooleanResultBlock)block;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)saveEventually BE_TV_UNAVAILABLE BE_WATCH_UNAVAILABLE;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
- (void)saveEventually:(nullable BEBooleanResultBlock)callback BE_TV_UNAVAILABLE BE_WATCH_UNAVAILABLE;
...
+ (void)saveAllInBackground:(nullable NSArray<BEObject *> *)objects
                      block:(nullable BEBooleanResultBlock)block;
 ...
 */
- (nullable instancetype)refresh BE_SWIFT_UNAVAILABLE PARSE_DEPRECATED("Please use `-fetch` instead.");
 ...
 */
- (void)refreshInBackgroundWithBlock:(nullable BEObjectResultBlock)block PARSE_DEPRECATED("Please use `-fetchInBackgroundWithBlock:` instead.");
 ...
 */
- (void)fetchInBackgroundWithBlock:(nullable BEObjectResultBlock)block;
...
/**
 ...
 It should have the following argument signature: `^(BEObject *object, NSError *error)`.
 */
- (void)fetchIfNeededInBackgroundWithBlock:(nullable BEObjectResultBlock)block;
...
+ (void)fetchAllInBackground:(nullable NSArray<BEObject *> *)objects
                       block:(nullable BEArrayResultBlock)block;
 ...
 *Asynchronously* loads data from the local datastore into this object,
 ...
 It should have the following argument signature: `^(BEObject *object, NSError *error)`.
 */
- (void)fetchFromLocalDatastoreInBackgroundWithBlock:(nullable BEObjectResultBlock)block;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
- (void)deleteInBackgroundWithBlock:(nullable BEBooleanResultBlock)block;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)deleteEventually BE_TV_UNAVAILABLE BE_WATCH_UNAVAILABLE;
 ...
 *Asynchronously* stores the object and every object it points to in the local datastore, recursively,
 ...
 @see `BEObjectDefaultPin`
 */
- (void)pinInBackgroundWithBlock:(nullable BEBooleanResultBlock)block;
 ...
 */
- (void)pinInBackgroundWithName:(NSString *)name block:(nullable BEBooleanResultBlock)block;
 ...
 *Asynchronously* stores the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (void)pinAllInBackground:(nullable NSArray<BEObject *> *)objects block:(nullable BEBooleanResultBlock)block;
 ...
 *Asynchronously* removes the object and every object it points to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
- (void)unpinInBackgroundWithBlock:(nullable BEBooleanResultBlock)block;
 ...
 */
- (void)unpinInBackgroundWithName:(NSString *)name block:(nullable BEBooleanResultBlock)block;
 ...
 *Asynchronously* removes all objects in the local datastore
 ...
 @see BEObjectDefaultPin
 */
+ (void)unpinAllObjectsInBackgroundWithBlock:(nullable BEBooleanResultBlock)block;
 ...
 *Asynchronously* removes all objects with the specified pin name.
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
+ (void)unpinAllObjectsInBackgroundWithName:(NSString *)name block:(nullable BEBooleanResultBlock)block;
 ...
 *Asynchronously* removes the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (void)unpinAllInBackground:(nullable NSArray<BEObject *> *)objects block:(nullable BEBooleanResultBlock)block;
