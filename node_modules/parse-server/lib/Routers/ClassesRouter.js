...
var ClassesRouter = exports.ClassesRouter = function (_PromiseRouter) {
  ...
  _createClass(ClassesRouter, [{
    ...
    value: function handleFind(req) {
      ...
      return _rest2.default.find(req.info, req.config, req.auth, req.params.className, body.where, options).then(function (response) {
    ...
    value: function handleGet(req) {
      ...
      return _rest2.default.find(req.info, req.config, req.auth, req.params.className, { objectId: req.params.objectId }, options).then(function (response) {
    ...
    value: function handleCreate(req) {
      return _rest2.default.create(req.info, req.config, req.auth, req.params.className, req.body);
    }
  }, {
    key: 'handleUpdate',
    value: function handleUpdate(req) {
      return _rest2.default.update(req.info, req.config, req.auth, req.params.className, req.params.objectId, req.body);
    }
  }, {
    key: 'handleDelete',
    value: function handleDelete(req) {
      return _rest2.default.del(req.info, req.config, req.auth, req.params.className, req.params.objectId).then(function () {
        return { response: {} };
      });
    }
  }, {
