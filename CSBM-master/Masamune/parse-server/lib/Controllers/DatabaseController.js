...
function DatabaseController(adapter) {
  ...
  var skipValidation = _ref2.skipValidation;
...
DatabaseController.prototype.find = function (className, query) {
  ...
  var acl = _ref7.acl;
  var _ref7$sort = _ref7.sort;
  var sort = _ref7$sort === undefined ? {} : _ref7$sort;
...
var untransformObjectACL = function untransformObjectACL(_ref8) {
  ...
  var _wperm = _ref8._wperm;

  var output = _objectWithoutProperties(_ref8, ['_rperm', '_wperm']);
