...
/** package */ final class ServiceUtils {
  private static final String TAG = "com.csbm.ServiceUtils";
  private static final String WAKE_LOCK_EXTRA = "beWakeLockId";

  private static final SparseArray<BEWakeLock> wakeLocks = new SparseArray<>();
  ...
  public static boolean runWakefulIntentInService(
    ...
    if (intent != null) {
      ...
      BEWakeLock wl = BEWakeLock.acquireNewWakeLock(context, PowerManager.PARTIAL_WAKE_LOCK, reason, 0);
