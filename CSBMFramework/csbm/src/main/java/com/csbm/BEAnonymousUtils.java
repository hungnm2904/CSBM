 ...
 * </ul>
 */
public final class BEAnonymousUtils {
   ...
   *         anonymous.
   */
  public static boolean isLinked(BEUser user) {
   ...
   */
  public static Task<BEUser> logInInBackground() {
    return BEUser.logInWithInBackground(AUTH_TYPE, getAuthData());
  }
  ...
  public static void logIn(LogInCallback callback) {
    BETaskUtils.callbackOnMainThreadAsync(logInInBackground(), callback);
  }
