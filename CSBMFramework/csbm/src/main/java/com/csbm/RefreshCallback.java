...
/**
 * A {@code RefreshCallback} is used to run code after refresh is used to update a {@link BEObject} in a
 * background thread.
 * <p/>
 ...
 * </pre>
 */
public interface RefreshCallback extends BECallback2<BEObject, BEException> {
  /**
