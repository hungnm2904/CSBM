...
/**
 * A {@code SignUpCallback} is used to run code after signing up a {@link BEUser} in a background
 * thread.
 * <p>
 ...
 * </pre>
 */
public interface SignUpCallback extends BECallback1<BEException> {
  /**
