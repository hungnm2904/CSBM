...
/* package */ abstract class BEEventuallyQueue {
   ...
   *          null.
   */
  public abstract Task<JSONObject> enqueueEventuallyAsync(BERESTCommand command,
                                                          BEObject object);

  protected BERESTCommand commandFromJSON(JSONObject json)
  ...
  /**
   * Gets notifications of various events happening in the command cache, so that tests can be
   * synchronized. See BECommandCacheTest for examples of how to use this.
   */
