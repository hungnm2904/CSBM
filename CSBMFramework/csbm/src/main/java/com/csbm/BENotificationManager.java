...
/** package */ class BENotificationManager {
  public static final String TAG = "com.csbm.BENotificationManager";
  
  public static class Singleton {
    private static final BENotificationManager INSTANCE = new BENotificationManager();
  }
  
  public static BENotificationManager getInstance() {
