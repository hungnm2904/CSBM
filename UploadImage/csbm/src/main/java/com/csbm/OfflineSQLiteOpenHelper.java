...
/** package */ class OfflineSQLiteOpenHelper extends BESQLiteOpenHelper {

  /**
   * The table that stores all BEObjects.
   */
  /* package */ static final String TABLE_OBJECTS = "BEObjects";

  /**
   * Various keys in the table of BEObjects.
   */
   ...
   */
  private static final String DATABASE_NAME = "BEOfflineStore";
